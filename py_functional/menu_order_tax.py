...
def summarize_order(order):
    ...
    tax = calculate_tax(subt)

    total = round(subt + tax, 2)

    names = [order[i]['name'] for i in range(len(order))]
...
def main():
    ...
    print(f'Summary: Ordered items are {items} and total bill {subtotal}')
